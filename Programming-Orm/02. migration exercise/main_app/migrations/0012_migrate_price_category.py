# Generated by Django 4.2.4 on 2023-10-24 17:06
...
def set_price(apps, schema_editor):
    ...
    for smartphone in smartphone_model.objects.all():
        smartphone.price = len(smartphone.brand) * MULTIPLE_PRICE
        smartphone.save()
...
def reverse_code(apps, schema_editor):
    smartphone_model = apps.get_model('main_app', 'Smartphone')
    smartphone_category_default = smartphone_model.meta.get_field("category").default
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(set_category_and_price, reverse_code=reverse_code)
    ]
