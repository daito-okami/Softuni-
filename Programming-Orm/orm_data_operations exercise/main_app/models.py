...
class HotelRoom(models.Model):
    ...
    room_type = models.CharField(max_length=20, choices=ROOM_TYPES_CHOICES)
    ...
    def __str__(self):
        return f"{self.room_type} room with number {self.room_number} cost {self.price_per_night}$ per night!"
