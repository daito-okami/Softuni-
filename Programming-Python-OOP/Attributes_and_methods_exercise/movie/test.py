from Attributes_and_methods_exercise.project.customer import Customer
from Attributes_and_methods_exercise.project.dvd import DVD
from Attributes_and_methods_exercise.project.movie_world import MovieWorld
